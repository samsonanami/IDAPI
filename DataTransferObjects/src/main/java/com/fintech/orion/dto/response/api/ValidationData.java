...
public class ValidationData {
    ...
    public boolean equals(Object o) {
        ...
        return isIdAndValueEqual(validationData) &&
                Objects.equals(this.ocrConfidence, validationData.ocrConfidence) &&
                isRemarksAndStatusEqual(validationData);

    }

    private boolean isIdAndValueEqual(ValidationData validationData) {
        return Objects.equals(this.id, validationData.id) &&
                Objects.equals(this.value, validationData.value);
    }

    private boolean isRemarksAndStatusEqual(ValidationData validationData) {
        return Objects.equals(this.remarks, validationData.remarks) &&
