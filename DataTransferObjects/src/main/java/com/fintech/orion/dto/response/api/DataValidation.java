...
public class DataValidation   {
  ...
  **/
  ...
  public DataValidation value(List<DataValidationValue> value) {
    this.value = value;
    return this;
  }

  public DataValidation addValueItem(DataValidationValue valueItem) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<DataValidationValue> getValue() {
    return value;
  }

  public void setValue(List<DataValidationValue> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    DataValidation dataValidation = (DataValidation) o;
    return Objects.equals(this.id, dataValidation.id) &&
        Objects.equals(this.value, dataValidation.value);
  }
